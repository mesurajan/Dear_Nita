       ...
       const quotes = [
            ...
            "You are my heart’s favorite adventure.",
            "I never knew love until I met you.",
            "My soul smiles every time you’re near.",
            "You are the poetry my heart has always wanted to write.",
            "Being with you is my definition of happiness.",
            "You make my world shine brighter than the stars.",
            "I am addicted to the way you make me feel.",
            "Your love is the rhythm my heart dances to.",
            "You complete the missing pieces of my soul.",
            "Every moment without you feels like a lifetime.",
            "My love for you grows deeper with every breath.",
            "You are the dream I never want to wake up from.",
            "Your touch ignites a fire that warms my entire being.",
            "I want to be your yesterday, today, and all my tomorrows.",
            "You are the sweetest thought I carry in my heart.",
            "Even in silence, my heart speaks your name.",
            "You are my forever, my always, my everything.",
            "No love story could ever compare to ours."
        ];
// Define card images and messages
      const cardData = [
            ...
            { frontImage: "Images/10.png", type: "image", quote: quotes[10] },
            { frontImage: "Images/09.png", type: "image", quote: quotes[11] },
            { frontImage: "Images/08.png", type: "image", quote: quotes[12] },
            { frontImage: "Images/07.png", type: "image", quote: quotes[13] },
            { frontImage: "Images/06.png", type: "image", quote: quotes[14] },
            { frontImage: "Images/05.png", type: "image", quote: quotes[15] },
            { frontImage: "Images/04.png", type: "image", quote: quotes[16] },
            { frontImage: "Images/03.png", type: "image", quote: quotes[17] },
            { frontImage: "Images/02.png", type: "image", quote: quotes[18] },
            { frontImage: "Images/01.png", type: "image", quote: quotes[19] }
        ];
...
function createCards() {
    cardData.forEach((data, index) => {
        ...
        // ✅ Add quote under the image on the front
        if (data.type === 'image') {
            const quoteElem = document.createElement('p');
            quoteElem.textContent = `"${data.quote}"`;
            quoteElem.style.fontSize = '1.6rem';
            quoteElem.style.fontWeight = '500';
            quoteElem.style.color = 'var(--text-color)';
            quoteElem.style.fontFamily = "'Dancing Script', cursive";
            quoteElem.style.marginTop = '15px';
            quoteElem.style.textAlign = 'center';
            cardFront.appendChild(quoteElem); // <-- add to front
        }

        // Create card back (still for messages/gifs if needed)
        ...
        makeCardDraggable(card);
            ...
            function showFinalMessage() {
                ...
                // Add final message
                const message = document.createElement('p');
                message.innerHTML = `Thank you for being the most incredible person in my world. Every moment with you is a 
                treasure, and I'm so grateful to share this journey with you. I love you more than words can express, and I 
                always will. Here's to creating countless more beautiful memories together! You bring light to my darkest days
                 and make every ordinary moment feel magical. I can’t wait to see what the future holds for 
                 us—together, always. 🌸`;
